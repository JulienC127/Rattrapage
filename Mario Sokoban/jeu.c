...
void jouer(SDL_Surface* ecran)
{
    ...
    mur = IMG_Load("herbe.png");
    caisse = IMG_Load("pokeball2.gif");
    caisseOK = IMG_Load("pokeball.gif");
    objectif = IMG_Load("dracau.gif");
    mario[BAS] = IMG_Load("pika_bas.gif");
    mario[GAUCHE] = IMG_Load("pika_gauche.gif");
    mario[HAUT] = IMG_Load("pika_haut.gif");
    mario[DROITE] = IMG_Load("pika_droite.gif");
