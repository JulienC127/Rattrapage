...
void jouer(SDL_Surface* ecran)
{
    ...
    objectif = IMG_Load("chest.png");
    mario[BAS] = IMG_Load("link_bas.gif");
    mario[GAUCHE] = IMG_Load("link_gauche.gif");
    mario[HAUT] = IMG_Load("link_haut.gif");
    mario[DROITE] = IMG_Load("link_droite.gif");
